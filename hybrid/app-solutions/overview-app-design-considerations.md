...
- [Desarrollo de plantillas de Azure Resource Manager para mantener la coherencia en la nube](/azure/azure-resource-manager/templates/templates-cloud-consistency)